...
Dispatch according to path, such as, exact match: domain.com/ws; prefix match when / is suffix: domain.com/api/, a special one: domain.com/ is exact match; default match: domain.com.
